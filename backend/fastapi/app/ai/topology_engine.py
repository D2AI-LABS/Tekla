...
def infer_missing_from_pattern(members: list, hierarchy: dict) -> List[dict]:
    ...
    for panel in panels:
        ...
        # ── 4-leg lattice tower (rectangular footprint, few legs) ────────
        if sym_type == "rectangular" and symmetry.get("n_legs") == 4 and len(levels) >= 3:
        ...
        elif sym_type in ("rectangular", "rectangular_grid", "elongated"):
